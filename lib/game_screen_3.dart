                    ...
                    onPressed: () {
                      Navigator.of(context).pushReplacement(
                        PageRouteBuilder(
                          ...
                          pageBuilder: (_, __, ___) => GameScreen4(
                            chestWasOpened: chestOpened,
                            hasHint: widget.hasHint,
                          ),
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushReplacement(
                      PageRouteBuilder(
                        transitionDuration: Duration(milliseconds: 800),
                        pageBuilder: (_, __, ___) => GameScreen2(
                          chestWasOpened: chestOpened,
                          hasHint: widget.hasHint,
                        ),
                        transitionsBuilder: (_, animation, __, child) =>
                  ...
                  child: Icon(Icons.reply, size: 36, color: Colors.black),
                ),
              ),
            ),
            Align(
