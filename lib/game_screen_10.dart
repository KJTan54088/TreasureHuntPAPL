...
import 'game_screen_11.dart';
import 'node.dart';

class GameScreen10 extends StatefulWidget {
  const GameScreen10({Key? key}) : super(key: key);
...
class _GameScreen10State extends State<GameScreen10> {
  ...
  Future<void> _saveProgress(BuildContext context) async {
    try {
      ...
      final newNode = Node(screen: 'GameScreen10', timestamp: timestamp);
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // Arrow button to go to GameScreen11
          Positioned(
                ...
                onPressed: () {
                  Navigator.of(context).pushReplacement(
                    PageRouteBuilder(
                      ...
                      pageBuilder: (_, __, ___) => GameScreen11(),
